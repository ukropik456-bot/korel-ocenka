      ...
      <section className="section" style={{ background: "rgba(58,24,51,.2)", borderTop: "1px solid rgba(196,162,44,.08)", borderBottom: "1px solid rgba(196,162,44,.08)" }}>
        <div className="section-inner">
          ...
          <div className="steps-grid">
            {[
              { n: "01", t: "Принимаем заявку",  d: "Отвечаем на звонок или форму в течение 15 минут — в любой день с 7:00 до 21:00." },
              { n: "02", t: "Уточняем детали",   d: "Согласовываем объект, цель оценки и сроки. Сообщаем, какие документы подготовить." },
              { n: "03", t: "Проводим оценку",   d: "Выезжаем к объекту или обрабатываем документы дистанционно — в согласованные сроки." },
              { n: "04", t: "Передаём отчёт",    d: "Оформляем официальный отчёт по ФЗ-135 и ФСО. Принимается банками, судами и госорганами." },
            ].map((s, i) => (
